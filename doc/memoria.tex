...
\newpage
\section*{\centerline{Declaración firmada sobre la originalidad del trabajo}}
...
\centerline{Murcia, a 23 de Junio de 2020}
\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth]{img/firma}
\end{figure}
\centerline{Fdo.: \docauthor}
\centerline{\textit{Autor del TF}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{img/convolution}
\caption{Convolución.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{img/atrous_convolution}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{img/max_pool}
...
La primera prueba consiste en hacer un entrenamiento completo ~\cite{tfguide} y así poder comparar los resultados con otras técnicas que voy a usar. En esta prueba se entrena de 0 la arquitectura \textit{AlexNet} para clasificar las imágenes del \textit{dataset} \textit{cifar 10}.
