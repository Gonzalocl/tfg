...
En el \textit{script} \texttt{acdc\_test.sh} se llaman a los \textit{scripts} anteriores donde se pueden ver los parámetros usados para la el entrenamiento del modelo.
